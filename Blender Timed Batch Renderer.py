...
#these are the try to run in the subprocess
    ...
    def aboutus(self):
        self.aboutuss=messagebox.askquestion("Know us","To know more about us and our projects visit www.engineerthoughts.com, press yes to visit our site")
        print(self.aboutuss)
    ...
    def cancelbutton(self):
        self.cancelbutto=messagebox.showwarning("alert","Do you sure want to cancel")
        print(self.cancelbutto)
        if self.cancelbutto=="ok":
            exit()
        else:
            pass
    ...
    def __init__(self, top=None):
        ...
        top.title("Blender Timed Batch renderer by Aranganathan")
        ...
        self.blocexe4.configure(text='''Enter the Time between each batch of frames in seconds''')
        ...
        self.cancelbut.configure(command=self.cancelbutton)
        ...
        self.Label1.configure(text='''BLENDER TIMED BATCH RENDERER''')
